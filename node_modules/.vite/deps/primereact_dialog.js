...
var useUnmountEffect2 = function useUnmountEffect3(fn) {
  return React11.useEffect(function() {
    return fn;
  }, []);
};
var useEventListener2 = function useEventListener3(_ref) {
  ...
  var listenerRef = React11.useRef(null);
...
var Dialog = React11.forwardRef(function(inProps, ref) {
  ...
  var _React$useState = React11.useState(uniqueId), _React$useState2 = _slicedToArray3(_React$useState, 2), idState = _React$useState2[0];
  _React$useState2[1];
  var _React$useState3 = React11.useState(false), _React$useState4 = _slicedToArray3(_React$useState3, 2), maskVisibleState = _React$useState4[0], setMaskVisibleState = _React$useState4[1];
  var _React$useState5 = React11.useState(false), _React$useState6 = _slicedToArray3(_React$useState5, 2), visibleState = _React$useState6[0], setVisibleState = _React$useState6[1];
  var _React$useState7 = React11.useState(props.maximized), _React$useState8 = _slicedToArray3(_React$useState7, 2), maximizedState = _React$useState8[0], setMaximizedState = _React$useState8[1];
  ...
  var createTemplateElement = function createTemplateElement2(_ref) {
    ...
    return React11.createElement("div", maskProps, React11.createElement(CSSTransition2, _extends5({
      nodeRef: dialogRef
    }, transitionProps), React11.createElement("div", rootProps, ObjectUtils.getJSXElement(inProps.content, templateElementProps))));
  };
  var createElement6 = function createElement7(_ref2) {
    ...
    return React11.createElement("div", maskProps, React11.createElement(CSSTransition2, _extends5({
      nodeRef: dialogRef
    }, transitionProps), React11.createElement("div", rootProps, header2, content2, footer2, resizer)));
  };
